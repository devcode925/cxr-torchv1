...
parser.add_argument('-saliency_map', default=None, help='path to write the saliancy map as an image')
...
class CovidSeverityNet(torch.nn.Module):
    def __init__(self):
        super(CovidSeverityNet, self).__init__()
